...
本文档适用于当前桌面项目 `D:\User\MC233\Desktop\LNU-LibSeat`。它和参考目录里的 `LNU-LibSeat-Automation` 是不同功能版本：当前项目以 PySide6 GUI、API 扫描规划、单账号逐段换座恢复、跨房间候选选择、多账号多方案分时段和低动画模式为核心。
...
| [v2.5.3 发布说明](RELEASE_BODY_v2.5.3.md) | 发布使用 | 本版本更新、注意事项和下载文案。 |
